...
const Presupuesto = () => {
  ...
  // Datos de ejemplo para las cuentas pendientes de orden de pago
  const cuentasPendientes = [
    {
      id: 1,
      radicado: 'RAD-2024-002',
      contratista: 'María Elena Rodríguez',
      contratoId: 'CT-2024-002',
      periodo: 'Septiembre 2024',
      valor: '$ 4.800.000',
      estado: 'Pendiente Orden de Pago',
      aprobadoPorSupervisor: '✓ Aprobado',
      fechaRadicado: '15/10/2024'
    },
    {
      id: 2,
      radicado: 'RAD-2024-014',
      contratista: 'Gabriel Antonio Silva',
      contratoId: 'CT-2024-014',
      periodo: 'Octubre 2024',
      valor: '$ 5.200.000',
      estado: 'Pendiente Orden de Pago',
      aprobadoPorSupervisor: '✓ Aprobado',
      fechaRadicado: '18/10/2024'
    }
  ];
  ...
  const columns = [
    ...
    {
      data: "aprobadoPorSupervisor", 
      title: "Aprobado por Supervisor",
      render: (data) => {
        return `<span class="text-success fw-bold">${data}</span>`;
      }
    },
  ...
  useEffect(() => {
    ...
    const tableContainer = document.querySelector(".tablaPresupuesto");
    if (tableContainer) {
  ...
  return (
    <>
      <div>
        <h2>Panel de Presupuesto - Cuentas Pendientes de Orden de Pago</h2>
      </div>
            ...
            {lstFiltrado && (
              <div className="container mb-4">
                ...
                <div className="row g-4 mb-4">
                  ...
                  <div className="col-md-6">
                    <div className="mb-2">
                      <span className="fw-semibold">Aprobado por Supervisor</span>
                    </div>
                    <p className="text-success fw-bold">{lstFiltrado.aprobadoPorSupervisor}</p>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div>
                        <span className="fw-semibold">Estado de Aprobación:</span>
                        <span className="ms-2 text-success fw-bold">{lstFiltrado.aprobadoPorSupervisor}</span>
                      </div>
                    </div>
                  </div>
                </div>
